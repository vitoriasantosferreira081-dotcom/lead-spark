...
function ProtectedRoute({ children }: { children: React.ReactNode }) {
  ...
  if (loading) return <div className="flex min-h-screen items-center justify-center bg-background"><div className="animate-pulse text-primary text-2xl font-bold">Carregando...</div></div>;
